...
| RN-22 | **Alcance social acotado**: compartir producto: sí. Seguimiento (follow): fuera del MVP. El perfil de usuario es privado; solo el Vendedor/Admin consulta el perfil de un usuario para ver todos sus pedidos. |

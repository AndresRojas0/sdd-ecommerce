...
| 8 | Avatar: implementado en código (`PUT /users/me/avatar`) pese a estar diferido en docs (`01-api-design.md` §8.4). | `01-api-design.md` §8.4 | Abierta — alinear docs o código |
